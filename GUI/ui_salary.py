...
"font: 9pt \"Segoe UI\";")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.salary_Monthly.setPlainText(QCoreApplication.translate("Dialog", u"25000.00", None))
        self.Monthly.setText(QCoreApplication.translate("Dialog", u"Monthly salary", None))
        self.benefits_Edu.setPlainText("Basic Education Package")
        ...
        self.salary_Overtime.setPlainText(QCoreApplication.translate("Dialog", u"250.00", None))
        self.salary_Total.setPlainText(QCoreApplication.translate("Dialog", u"25250.00", None))
        ...
        self.benefits_Med.setPlainText("Basic Medical Package")
