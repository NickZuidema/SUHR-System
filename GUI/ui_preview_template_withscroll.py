...
################################################################################
## Form generated from reading UI file 'preview_template_withscrollCANLASYWihSl.ui'
##
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, -225, 1390, 918))
...
"color: black;")
        ...
        sizePolicy.setHeightForWidth(self.employee_philHealth.sizePolicy().hasHeightForWidth())
        self.employee_philHealth.setSizePolicy(sizePolicy)
        font = QFont()
        ...
        self.gridLayout.addWidget(self.contact_header, 15, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.employee_children, 17, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.employee_religion, 22, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.employee_phonenumber, 17, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.church_header, 21, 0, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.employee_email, 18, 1, 1, 1)
