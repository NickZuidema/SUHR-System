...
################################################################################
## Form generated from reading UI file 'preview_template_withscrollCANLASBlSewr.ui'
##
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, -163, 1390, 829))
...
"color: black;")
        ...
        self.gridLayout.addWidget(self.sss_header, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.church_header, 20, 0, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.employee_philHealth, 14, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.employee_religion, 24, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.employee_pagibig, 12, 1, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.employee_publications.sizePolicy().hasHeightForWidth())
        self.employee_publications.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout.addWidget(self.employee_publications, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.pagibig_header, 11, 1, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.employee_dumaguete_address.sizePolicy().hasHeightForWidth())
        self.employee_dumaguete_address.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout.addWidget(self.employee_sss, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.publications_header, 5, 2, 1, 1)
        ...
        self.employee_relation.setStyleSheet(u"border: 1px solid black;")
        ...
        self.gridLayout.addWidget(self.ph_header, 13, 1, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.employee_brother.sizePolicy().hasHeightForWidth())
        self.employee_brother.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout.addWidget(self.acad_record_header, 7, 2, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.employee_acad_record.sizePolicy().hasHeightForWidth())
        self.employee_acad_record.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout.addWidget(self.employee_acad_record, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.contact_header, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.employee_phonenumber, 10, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.employee_email, 11, 2, 1, 1)
