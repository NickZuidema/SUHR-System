...
################################################################################
## Form generated from reading UI file 'add_employee_recordqQueRR.ui'
##
...
"")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 1312, 3639))
        ...
        self.gridLayout.addWidget(self.scholarships_awards, 58, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.sibling2_FirstName, 35, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Father_MiddleName, 28, 7, 1, 2)

        self.label_15 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setStyleSheet(u"font: 9pt \"Outfit\";")

        self.gridLayout.addWidget(self.label_15, 16, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.PlaceOfBirth, 15, 2, 1, 8)

        self.label_30 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_30.setObjectName(u"label_30")

        self.gridLayout.addWidget(self.label_30, 33, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.staff_MiddleName1, 54, 2, 1, 2)
...
"")
        ...
        self.gridLayout.addWidget(self.yeargraduate_elementary, 46, 13, 1, 4)
        ...
        self.gridLayout.addWidget(self.Siblings_ignore, 33, 16, 1, 1)
        ...
        self.gridLayout.addWidget(self.yeargraduate_graduateschool, 52, 13, 1, 4)
        ...
        self.gridLayout.addWidget(self.Graduateschool, 51, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.sibling1_address, 34, 14, 1, 3)
        ...
        self.gridLayout.addWidget(self.government_date, 68, 7, 1, 5)
        ...
        self.gridLayout.addWidget(self.staff_MiddleName2, 55, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.address_graduateschool, 52, 1, 1, 3)

        self.case_addfield = QPushButton(self.scrollAreaWidgetContents_2)
        self.case_addfield.setObjectName(u"case_addfield")

        self.gridLayout.addWidget(self.case_addfield, 72, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.sibling2_occupation, 35, 6, 1, 8)

        self.label_42 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_42.setObjectName(u"label_42")

        self.gridLayout.addWidget(self.label_42, 70, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.sibling1_occupation, 34, 6, 1, 8)
        ...
        self.gridLayout.addWidget(self.line, 14, 0, 60, 1)
        ...
        self.gridLayout.addWidget(self.staff_position2, 55, 13, 1, 4)
        ...
        self.gridLayout.addWidget(self.diploma_highschool, 48, 4, 1, 9)
        ...
        self.gridLayout.addWidget(self.ChurchAffiliation, 26, 1, 1, 16)

        self.label_39 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_39.setObjectName(u"label_39")

        self.gridLayout.addWidget(self.label_39, 60, 1, 1, 2)

        self.pushButton_2 = QPushButton(self.scrollAreaWidgetContents_2)
        self.pushButton_2.setObjectName(u"pushButton_2")

        self.gridLayout.addWidget(self.pushButton_2, 73, 16, 1, 1)
        ...
        self.gridLayout.addWidget(self.NONFILIPINO_acrnum, 18, 8, 1, 8)
        ...
        self.gridLayout.addWidget(self.label_41, 67, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.government_addfield, 69, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.HomeAddress, 12, 1, 2, 16)
        ...
        self.gridLayout.addWidget(self.Mother_FirstName, 31, 1, 1, 6)
        ...
        self.gridLayout.addWidget(self.MotherAddress, 32, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.MiddleName, 3, 5, 1, 6)
        ...
        self.gridLayout.addWidget(self.ContactNumber, 20, 1, 1, 5)
        ...
        self.gridLayout.addWidget(self.staff_addfield, 56, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.DumaAddress, 10, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.staff_LastName2, 55, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.address_highschool, 48, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.ChurchAffiliation_ignore, 25, 16, 1, 1)
        ...
        self.gridLayout.addWidget(self.staff_FirstName2, 55, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.staff_relationship2_2, 55, 5, 1, 8)
        ...
        self.gridLayout.addWidget(self.staff_relationship2, 54, 5, 1, 8)
        ...
        self.gridLayout.addWidget(self.NONFILIPINO_ignore, 16, 16, 1, 1)

        self.label_26 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_26.setObjectName(u"label_26")

        self.gridLayout.addWidget(self.label_26, 27, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.address_employment, 65, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.period_employment, 64, 9, 1, 3)
        ...
        self.gridLayout.addWidget(self.TINnumber, 22, 1, 1, 7)
        ...
        self.gridLayout.addWidget(self.yeargraduate_highschool, 48, 13, 1, 4)

        self.label_18 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_18.setObjectName(u"label_18")

        self.gridLayout.addWidget(self.label_18, 17, 16, 1, 1)

        self.label_20 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_20.setObjectName(u"label_20")

        self.gridLayout.addWidget(self.label_20, 19, 6, 1, 3)
        ...
        self.gridLayout.addWidget(self.sibling1_LastName, 34, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.diploma_graduateschool, 52, 4, 1, 9)
        ...
        self.gridLayout.addWidget(self.Father_LastName, 28, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.name_employer, 64, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.record_employee_ignore, 63, 14, 1, 3)
        ...
        self.gridLayout.addWidget(self.sibling2_address, 35, 14, 1, 3)
        ...
        self.gridLayout.addWidget(self.MotherJob, 31, 10, 1, 7)
        ...
        self.gridLayout.addWidget(self.label_16, 17, 1, 1, 1)

        self.label_36 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_36.setObjectName(u"label_36")

        self.gridLayout.addWidget(self.label_36, 44, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.government_rating, 68, 3, 1, 4)

        self.label_38 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_38.setObjectName(u"label_38")

        self.gridLayout.addWidget(self.label_38, 57, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.elementary_school, 45, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.PagIbigNumber, 24, 1, 1, 7)
        ...
        self.gridLayout.addWidget(self.label_40, 63, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.address_college, 50, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.College, 49, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.yeargraduate_college, 50, 13, 1, 4)
        ...
        self.gridLayout.addWidget(self.NONFILIPINO_passport, 18, 1, 1, 7)
        ...
        self.gridLayout.addWidget(self.children_addfield, 43, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.NONFILIPINO_dateissued, 18, 16, 1, 1)
        ...
        self.gridLayout.addWidget(self.staff_FirstName1, 54, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.FatherAddress, 29, 1, 1, 16)

        self.label_22 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_22.setObjectName(u"label_22")

        self.gridLayout.addWidget(self.label_22, 21, 8, 1, 4)
        ...
        self.gridLayout.addWidget(self.SSSnumber, 22, 8, 1, 9)

        self.label_37 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_37.setObjectName(u"label_37")

        self.gridLayout.addWidget(self.label_37, 53, 1, 1, 2)

        self.label_25 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_25.setObjectName(u"label_25")

        self.gridLayout.addWidget(self.label_25, 25, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_24, 23, 8, 1, 4)

        self.label_19 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_19.setObjectName(u"label_19")

        self.gridLayout.addWidget(self.label_19, 19, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Citizenship, 15, 10, 1, 7)
        ...
        self.gridLayout.addWidget(self.sibling1_MiddleName, 34, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.elementary_school_address, 46, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.Government_place, 68, 12, 1, 5)
        ...
        self.gridLayout.addWidget(self.government_examination, 68, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.sibling1_FirstName, 34, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.publications_addfield, 62, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.label_29, 30, 10, 1, 5)
        ...
        self.gridLayout.addWidget(self.diploma_elementary, 46, 4, 1, 9)
...
"font: 600 14pt \"Outfit SemiBold\";")
        ...
        self.gridLayout.addWidget(self.criminalcases_ignore, 70, 16, 1, 1)
        ...
        self.gridLayout.addWidget(self.diploma_college, 50, 4, 1, 9)
        ...
        self.gridLayout.addWidget(self.reason, 64, 12, 1, 5)
        ...
        self.gridLayout.addWidget(self.Mother_MiddleName, 31, 7, 1, 2)
        ...
        self.gridLayout.addWidget(self.DateOfBirth, 15, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.staff_position3, 54, 13, 1, 4)
        ...
        self.gridLayout.addWidget(self.Department, 7, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.SurName, 3, 11, 1, 6)
        ...
        self.gridLayout.addWidget(self.case_name, 71, 1, 1, 16)
        ...
        self.gridLayout.addWidget(self.sibling2_LastName, 35, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.FatherJob, 28, 10, 1, 7)
        ...
        self.gridLayout.addWidget(self.Father_FirstName, 28, 1, 1, 6)
        ...
        self.gridLayout.addWidget(self.PhilHNumber, 24, 8, 1, 9)

        self.label_21 = QLabel(self.scrollAreaWidgetContents_2)
        self.label_21.setObjectName(u"label_21")

        self.gridLayout.addWidget(self.label_21, 21, 1, 1, 2)
